...
class Facepp
{
    ...
    public $api_key         = '3ff1ef920dd5cd207d6462a830297209';        // set your API KEY or set the key static in the property
    public $api_secret      = 'aXmC6XWFyFq6kFuP1NvK-y3m8EfSXo9p';        // set your API SECRET or set the secret static in the property
