...
<div class="reset" style="text-align: center">
    <button type="reset" onclick="initMap();">重新定位</button>
</div>
</body>
...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(113.38128,23.127062);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"帕克西软件开发有限公司",content:"联系人：张总",point:"113.380507|23.127536",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
    ];
    //创建marker
    function addMarker(){
